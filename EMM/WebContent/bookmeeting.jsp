...
<meta charset="utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function body_load() {
            ...
            $.post("./getalldepjson", function (msg) {
...
//            }
            ...
            $.post("./getempbydepid", {depid: departmentid}, function (msg) {
                for (var i = 0; i < msg.length; i++) {
                    var item = msg[i];
...
<div class="class="x-body"">
<blockquote class="layui-elem-quote">
             会议管理 > 预定会议
            </blockquote>
            <fieldset class="layui-elem-field layui-field-title site-title">
              <legend><a name="default">会议信息</a></legend>
            </fieldset>
             <form action="${pageContext.request.contextPath}/dobookmeeting" method="post">
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="divoperator">
                                <input type="button" value="&gt;" onclick="selectEmployees()"/>
                                <input type="button"  value="&lt;" onclick="deSelectEmployees()"/>
                            </div>
                            <div id="divto">
